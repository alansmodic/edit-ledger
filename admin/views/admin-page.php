...
<div class="wrap">
    ...
    <div class="edit-ledger-filters">
        <form id="edit-ledger-filter-form">
            ...
            <label for="filter-after" class="screen-reader-text">
                <?php esc_html_e('After date', 'edit-ledger'); ?>
            </label>
            <input type="date" id="filter-after" name="after"
                placeholder="<?php esc_attr_e('After', 'edit-ledger'); ?>">

            <label for="filter-before" class="screen-reader-text">
                <?php esc_html_e('Before date', 'edit-ledger'); ?>
            </label>
            <input type="date" id="filter-before" name="before"
                placeholder="<?php esc_attr_e('Before', 'edit-ledger'); ?>">
    ...
    <div id="edit-ledger-modal" class="edit-ledger-modal" style="display: none;">
        ...
        <div class="edit-ledger-modal__content">
            <div class="edit-ledger-modal__header">
                ...
                <button type="button" class="edit-ledger-modal__close"
                    aria-label="<?php esc_attr_e('Close', 'edit-ledger'); ?>">&times;</button>
            </div>
            <div class="edit-ledger-modal__controls">
                <button type="button" class="button button-primary"
                    data-mode="inline"><?php esc_html_e('Inline', 'edit-ledger'); ?></button>
                <button type="button" class="button"
                    data-mode="side-by-side"><?php esc_html_e('Side by Side', 'edit-ledger'); ?></button>
            </div>
